# Acquisition de congés payés pendant un arrêt maladie — personnel Non Cadre

- **Date de signature :** 31 décembre 2025
- **Source :** converti depuis `Accord_acquisition_CP_sur_maladie-Non_cadres.md` (Word), version de travail définitive avant signature
...
C'est ainsi qu'il a été convenu de remplacer l'article 4.1.4 de l'article sur l'aménagement du temps de travail des salariés non-cadre par l'article suivant :

**ARTICLE 1 -- Modification de l'article 4.1.4 :**

La rédaction suivant remplace et annuelle celle de l'article 4.1.4 de l'accord d'ATT des salariés non-cadres de l'ICO.

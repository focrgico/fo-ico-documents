# Avenant n°1 à l'accord Durée et ATT Non Cadre (CET heures supplémentaires)

- **Date de signature :** 31 janvier 2022
- **Source :** converti depuis `Accord_ATT_NC_Avenant_n_1_vDéfinitive.md` (Word), version de travail définitive avant signature
- **Document signé de référence (preuve juridique) :** PDF correspondant, conservé dans le même dossier- **Signataires (vérifiés sur PDF) :** CGT-FO (D. DI PERI), CFDT (C. LANIO), CFE-CGC (G. PERROCHEAU). Sud Santé-Sociaux (J. ROSAN) n'a pas signé.
...
-   Pour l'organisation syndicale **CGT-FO** représentée par Monsieur David DI PERI agissant en qualité de délégué(e) syndical(e) central(e)

-   Pour l'organisation syndicale **Sud Santé-Sociaux** représentée par Monsieur Julien ROSAN agissant en qualité de délégué(e) syndical(e) central(e)

-   Pour l'organisation syndicale **CFDT** représentée par Madame Corinne LANIO agissant en qualité de délégué(e) syndical(e) central(e)

-   Pour l'organisation syndicale **CFE-CGC** représentée par Madame Geneviève PERROCHEAU

> agissant en qualité de délégué(e) syndical(e) central(e)
